...
CREATE TABLE `tblcustomer` (
  ...
  `customerDP` varchar(450) COLLATE utf8_unicode_ci DEFAULT NULL,
...
(1, 'Mark Joseph', 'Baghari', 'Publico', 'Blk. 6 Lt. 1, UCV Village, Sapang Viejo, Ligid-Tipas, Taguig City', '09197464382', 'mjoseph.publico@gmail.com', '2017-09-251506301809.png', 1, 'active'),
(2, 'Erica', 'Vineza', 'Cuachin', 'Ph. 1 Blk. 8 Lt. 32, Green Breeze Subd., San Isidro, Rodriguez, Rizal', '09099633885', 'erica.cuachin@gmail.com', '2017-09-251506306079.png', 0, 'active');
...
(15, 'roguh', 'gaspang iihhh', 50, 'Listed'),
(16, 'smooth', 'makinis talaga', 2, 'Listed'),
(17, 'rough', 'magaspang', 77, 'Listed');
...
(7, 'Montesquieu', 'Montesquieu', 'Listed'),
(8, 'Kaizer', 'Emperor styled framework design.', 'Listed'),
(9, 'Knight', 'Medieval Design', 'Listed');
...
(1, 'mj', '123456', 'active', 'customer', 1, NULL, '2017-09-24'),
(2, 'kikay', '123456', 'active', 'customer', 2, NULL, '2017-09-25');
...
--
ALTER TABLE `tblfabric_texture`
  MODIFY `textureID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
--
